...
function TechnologyUsed() {
    ...
    return (
        <section className='mt-5' style={{ backgroundColor: 'rgba(187, 243, 192, 0.91)', padding: '30px' }} id='Technologies'>
                ...
                <div className="row row-cols-md-12">
                    {technologies.map((technology) => (
                        <div className="col-xs-12 col-sm-2">
                            <div className="card d-flex flex-column h-100 mb-4" style={{ backgroundColor: 'rgba(187, 243, 192, 0)',border: "0", marginLeft: '25%' }}>
                                <a className="img-card">
                                    <img src={technology?.image} alt='' style={{ padding: '30px', width: '100%', borderRadius: '50%' }} />
                                </a>
